...
class UnityAdsService {
  constructor(config) {
    this.apiUrl = config.apiUrl || 'https://api.unity3d.com/v1';
  ...
  async bid(placementId, userData) {
    try {
      ...
      console.error('Unity Ads竞价失败:', error);
      return null;
    }
  }
  ...
  render(adData) {
    ...
    container.className = 'unity-ads-container';
    ...
    videoContainer.className = 'unity-video-container';
    ...
    skipButton.className = 'unity-skip-button';
    ...
    progressBar.className = 'unity-progress-bar';
    ...
    progress.className = 'unity-progress';
  ...
  async trackClick(adId) {
    try {
      ...
      console.error('Unity Ads点击追踪失败:', error);
    }
  }
}

module.exports = UnityAdsService; 